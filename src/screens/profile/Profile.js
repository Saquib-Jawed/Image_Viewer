...
class Profile extends Component {
    constructor() {
        ...
        this.state = {
            userImages: [],
            username: properties.username, // Reading username from config file.
            fullName: properties.fullName, // Reading name from config file.
            url: properties.dpUrl, // Reading profile picture URL from config file.
    ...
    // On clicking like button, like count increase.
    likeHandler = (index) => {
    ...
    // On clicking Add button, adding new comment for that image.
    addCommentHandler = () => {
    ...
    async componentDidMount() {
        ...
        for (let i = 0; i < posts.length; i++) {
            ...
            posts[i].tags = "#upgrad #upgradproject #reactjs"; // Reading hashtags from config file.
            posts[i].likes = Math.round(Math.random() * 100);
            posts[i].liked = false; // liked status for the user.
        }
