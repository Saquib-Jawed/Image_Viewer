...
class Home extends Component {
    ...
    async componentDidMount() {
            ...
            for (let i = 0; i < posts.length; i++) {
                ...
                posts[i].tags = properties.hashTags; // Reading hashtags from config file.
                posts[i].likes = Math.round(Math.random() * 100); // Random likes for each image.
                posts[i].isLiked = false; // liked status for the current user.
            }
    ...
    render() {
        ...
        return (
            <div>
                <div>
                    {/* Header component with Show Search and Show My Account. */}
